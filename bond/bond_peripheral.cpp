...
BondPeripheral::BondPeripheral(uint8_t _reqn, uint8_t _rdyn, uint16_t _eepromOffset, uint8_t _index) : BlueCapBondPeripheral(_reqn, _rdyn, _eepromOffset, _index) {
